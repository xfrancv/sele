...
%%
if ~exist( outFile )
    system('wget --no-check-certificate https://www.csie.ntu.edu.tw/~cjlin/libsvmtools/datasets/multiclass/Sensorless');
end

%%
[Y, X] = libsvmread('Sensorless');
X = full(X)';
