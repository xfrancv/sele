/*=================================================================
 * UNILBPPYR computes uniform LBP features on scale-pyramid of input image.
 * 
 * Synopsis:
 *  F = unilbppyr_mat(I, P)
 * where
...
void mexFunction( int nlhs, mxArray *plhs[],int nrhs, const mxArray *prhs[] )
{
  ...
  if( nrhs != 2 )
    mexErrMsgTxt("Two input arguments required.\n\n"
                 ...
                 "Synopsis:\n"
                 "  features = lbppyr2(img, heightOfpyramid)\n"
                 "where\n"
...
/*  mexPrintf("num_cols: %d\nnum_rows=%d\nheight_of_pyramid=%d\n", num_cols,num_rows, height_of_pyramid);*/
  ...
  num_features = liblbp_uniform_pyr_get_dim(num_rows, num_cols, height_of_pyramid);

  plhs[0] = mxCreateNumericMatrix(num_features, 1, mxUINT8_CLASS, mxREAL);
  p_features = (char*)mxGetPr(plhs[0]);
  liblbp_uniform_pyr_features(p_features, num_features, p_tmp_img, num_rows, num_cols );
