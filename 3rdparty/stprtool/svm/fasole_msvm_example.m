% Example: Learning multi-class linear classifier by solver for SO-SVM.
%
...
% call BMRM solver
% [W,Stat1] = bmrm( Data, @risk_msvm, lambda, Opt );

[W,Stat] = fasole( Data, nExamples, @loss_msvm, lambda );
