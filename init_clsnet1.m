function Net = init_clsnet1(nInputs, nOutputs, nHiddenStates, varargin )
% 
...
%
    ...
    %% Loss functions
    Net.addLayer('softmaxlog', dagnn.Loss('loss','softmaxlog'), {'prediction','label'}, 'objective' );
    Net.addLayer( 'loss', dagnn.LossCustom('Loss',opts.Loss), {'prediction','label'}, 'loss' );
