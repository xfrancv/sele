...
dataSet = { {'metro1',[100 500 1000 5000 10000] }};
...
%        run_train_conf_sele_mlp( dataSet{i}{1}, 'hinge1+zmuv', trnData);    
        run_train_conf_sele_linear( dataSet{i}{1}, 'sele1+zmuv', trnData);  
        run_train_conf_sele_linear( dataSet{i}{1}, 'sele2+zmuv', trnData);  
        run_train_conf_sele_quad( dataSet{i}{1}, 'sele1+zmuv', trnData);  
    end
end
