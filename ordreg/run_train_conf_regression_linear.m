function run_train_conf_regression_linear( dataSet, setting, trnData )
...
%
    ...
    if nargin >= 3
        ...
        outFolder = sprintf('%sconf_regression_linear_zmuv%d_trn%.f/', rootFolder, zmuvNorm, trnData );        
    else
        outFolder = sprintf('%sconf_regression_linear_zmuv%d/', rootFolder, zmuvNorm );        
    end
