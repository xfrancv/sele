...
%
    ...
    if nargin >= 3
        ...
        outFolder = sprintf('%sconf_sele%d_linear_zmuv%d_trn%.f/', rootFolder, riskType, zmuvNorm, trnData );    
    else
        outFolder = sprintf('%sconf_sele%d_linear_zmuv%d/', rootFolder, riskType, zmuvNorm );  
    end
