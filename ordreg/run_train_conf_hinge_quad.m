function run_train_conf_hinge_quad( dataSet, setting, batchSize, trnData )
...
%
    ...
    if nargin >= 4
        ...
        outFolder = sprintf('%sconf_hinge%d_quad_zmuv%d_bs%d_trn%.f/', rootFolder, riskType, zmuvNorm, batchSize, trnData ); 
    else
        outFolder = sprintf('%sconf_hinge%d_quad_zmuv%d_bs%d/', rootFolder, riskType, zmuvNorm, batchSize );        
    end
