...
%
    ...
    if nargin >= 3
        ...
        outFolder = sprintf('%sconf_sele%d_quad_zmuv%d_trn%.f/', rootFolder, riskType, zmuvNorm, trnData ); 
    else
        outFolder = sprintf('%sconf_sele%d_quad_zmuv%d/', rootFolder, riskType, zmuvNorm );   
    end
