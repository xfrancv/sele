...
outFile = '../../../data/ijcnn1.mat';
portions = [0.3 0.3 0.1 0.1 0.2]; % trn1 trn2 val1 val2 tst
nSplits  = 5;

%%
if ~exist( outFile )
    system('wget --no-check-certificate https://www.csie.ntu.edu.tw/~cjlin/libsvmtools/datasets/binary/ijcnn1.tr.bz2');
    system('wget --no-check-certificate https://www.csie.ntu.edu.tw/~cjlin/libsvmtools/datasets/binary/ijcnn1.val.bz2');
    system('bunzip2 ijcnn1.tr.bz2');
    system('bunzip2 ijcnn1.val.bz2');
    system('cat ijcnn1.tr ijcnn1.val > ijcnn1.svmlight');
end



%%
[Y, X] = libsvmread('ijcnn1.svmlight');
X = full(X)';
