function Net = init_confnet_regression(nInputs, nOutputs, nHiddenStates, varargin )
% 
...
%
    ...
    %% Loss functions
    Net.addLayer('rankloss', dagnn.LossRegressionSwitch(), {'prediction','loss','predY'}, 'objective' );
