/*=================================================================
 * LTPPYRSPARSE computes uniform LBP features on scale-pyramid of input image.
 * 
 * Synopsis:
 *  F = ltppyr(I, P, th)
 * where
 ...
 *  [numFeatures x 1 (sparse)] LBP features stucked to a column vector. 
 *
 *=================================================================*/
...
void mexFunction( int nlhs, mxArray *plhs[],int nrhs, const mxArray *prhs[] )
{
  ...
  if( nrhs != 3 )
    mexErrMsgTxt("Two input arguments required.\n\n"
                 "LTPPYRSPARSE computes LTP features on scale-pyramid of the input image.\n"
                 "Synopsis:\n"
                 "  features = ltppyrsparse(img, heightOfpyramid, th)\n"
                 "where\n"
                 ...
                 "  features [numFeatures x 1 (sparse)] LBP features stucked to column vector. \n");
...
/*  mexPrintf("num_cols: %d\nnum_rows=%d\nheight_of_pyramid=%d\nth=%d\n", num_cols,num_rows, height_of_pyramid, th);*/
  ...
  liblbp_ltp_pyr_features_sparse(p_index, nnz, p_tmp_img, num_rows, num_cols, th );
